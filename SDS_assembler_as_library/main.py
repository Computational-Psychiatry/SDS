...
def main():
    ...
    # Base directory paths for source and rawgit reset HEAD data
    BASE_DIR = "C:\\Users\\pargim\\PycharmProjects\\All_SDS_libraries_and_executables\\"
    BASE_SOURCE_DIR = os.path.join(BASE_DIR, "source")
    BASE_RAW_DIR = os.path.join(BASE_DIR, "raw")
    BASE_DIR_CSV_output = os.path.join(BASE_DIR,"outputs","Source_SDS_details_complied.csv")
